    ...
    function onButton(x as Number, y as Number) {
        switch (y) {
            case 0:
                switch (x) {
                    case 0:
                        _logic.setOperator(LX_OPERATOR_ADD);
                        sw();
                        break;
                    case 1:
                        _logic.setOperator(LX_OPERATOR_SUBTRACT);
                        sw();
                        break;
                    case 2:
                        _logic.setOperator(LX_OPERATOR_MULTIPLY);
                        sw();
                        break;
                }
                break;
            case 1:
                switch (x) {
                    case 0:
                        _logic.setOperator(LX_OPERATOR_DIVIDE);
                        sw();
                        break;
                    case 1:
                        _logic.setOperator(LX_OPERATOR_POWER);
                        sw();
                        break;
                    case 2:
                        _logic.toggleNegative();
                        sw();
                        break;
                }
                break;
            case 2:
                switch (x) {
                    case 0:
                        _logic.setValue(Math.pow(_logic.getAsDouble(), 0.5), {
                            :addToHistory => true,
                        });
                        sw();
                        break;
                    case 1:
                        _logic.setValue(Math.pow(_logic.getAsDouble(), 2), {
                            :addToHistory => true,
                        });
                        sw();
                        break;
